...
class CreditState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('menuBGa'));
		bg.scrollFactor.x = 0;
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, 'Vs. Mami FULL WEEK [v1.02]', 12); //perdon por robar codigo doy asco programando
		...
		add(specialThanksText);
		    ...
		    specialThanksText.text = "SPECIAL THANKS TO THE FOLLOWING\n" + " \n" + "Kade Dev - Kade Engine\n" + "Sector03 - Credits code\n" + "TheZoroForce - Extra note code\n" + "Sr Perez - Extra note creator\n" + "yesnt - Code help\n" + "Apendice chileno - Background art\n" + "Gruff - Back On song\n" + "Thomas - Zellen Madness chart\n" + "Enrique - Some ideas\n";
				...
				FlxG.sound.play(Paths.sound('confirmMenu'));
					...
					switch (daChoice)
					{
						case 'faderevampedtext':
							#if linux
							Sys.command('/usr/bin/xdg-open', ["https://www.instagram.com/gus_machicado/", "&"]);
							#else
							FlxG.openURL('https://www.instagram.com/gus_machicado/');
							#end
						case 'eggoverlordtext':
							#if linux
							Sys.command('/usr/bin/xdg-open', ["https://www.instagram.com/whittyposya/", "&"]);
							#else
							FlxG.openURL('https://www.instagram.com/whittyposya/');
							#end
						case 'theawfulusernametext':
							#if linux
							Sys.command('/usr/bin/xdg-open', ["https://www.instagram.com/_.todoshinku37._/", "&"]);
							#else
							FlxG.openURL('https://www.instagram.com/_.todoshinku37._/');
							#end
						case 'boinkbonktext':
							#if linux
							Sys.command('/usr/bin/xdg-open', ["https://twitter.com/unjovengranaino", "&"]);
							#else
							FlxG.openURL('https://twitter.com/unjovengranaino');
							#end
						case 'sectortext':
							#if linux
							Sys.command('/usr/bin/xdg-open', ["https://twitter.com/MassaGamer29", "&"]);
							#else
							FlxG.openURL('https://twitter.com/MassaGamer29');
							#end
						case 'vidztext':
							#if linux
							Sys.command('/usr/bin/xdg-open', ["https://www.instagram.com/ireneko_chan/", "&"]);
							#else
							FlxG.openURL('https://www.instagram.com/ireneko_chan/');
							#end
						case 'magbrostext':
							#if linux
							Sys.command('/usr/bin/xdg-open', ["https://twitter.com/Zykoxical", "&"]);
							#else
							FlxG.openURL('https://twitter.com/Zykoxical');
							#end
						case 'ascentitext':
							#if linux
							Sys.command('/usr/bin/xdg-open', ["https://www.instagram.com/the_pinokio_official/", "&"]);
							#else
							FlxG.openURL('https://www.instagram.com/the_pinokio_official/');
							#end
						case 'kayotext':
							#if linux
							Sys.command('/usr/bin/xdg-open', ["https://twitter.com/LaCuevaDeDuve", "&"]);
							#else
							FlxG.openURL('https://twitter.com/LaCuevaDeDuve');
							#end
						case 'cerberatext':
							#if linux
							Sys.command('/usr/bin/xdg-open', ["https://twitter.com/AirinGPS", "&"]);
							#else
							FlxG.openURL('https://twitter.com/AirinGPS');
							#end
					}
				}
			}
	...
	function changeItem(huh:Int = 0)
	{
		...
		{
			case 0:
				creditRoleText.text = "Director, Animator, Coder";
				creditNameText.text = "Gustav Zerok";
			case 1:
				creditRoleText.text = "Beta Tester";	
				creditNameText.text = "Whitty";
			case 2:
				creditRoleText.text = "Artist (some poses)";
				creditNameText.text = "Shinku";
			case 3:
				creditRoleText.text = "Charter";	
				creditNameText.text = "Nozferatu";
			case 4:
				creditRoleText.text = "Artist (Miscellaneous and background)";	
				creditNameText.text = "Massacre";
			case 5:
				creditRoleText.text = "Artist (InfraZellen disign)";
				creditNameText.text = "Ireneko";
			case 6:
				creditRoleText.text = "Principal Musician";
				creditNameText.text = "Zykoxic";
			case 7:
				creditRoleText.text = "Artist (zellen and background)";
				creditNameText.text = "The Pinokio";
			case 8:
				creditRoleText.text = "Secundary Musician"; 
				creditNameText.text = "Duve";
			case 9:
				creditRoleText.text = "Dialogue, Artist (itself)";
				creditNameText.text = "IreneGPS";					
		}
	}
